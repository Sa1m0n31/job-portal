...
import {deleteFastOffer, deleteOffer, getFastOfferById, getOfferById} from "../helpers/offer";
                ...
                <div className="adminMain__main">
                    ...
                    <div className="flex">
                        <h1 className="adminMain__header">
                            Szczegóły błyskawicznej oferty pracy
                        </h1>
